...
public class StudentSteps {
    ...
    @And("^I update the student with the information firstName \"([^\"]*)\" lastName \"([^\"]*)\" email \"([^\"]*)\" programme \"([^\"]*)\" courses \"([^\"]*)\"$")
    public void iUpdateTheStudentWithTheInformationFirstNameLastNameEmailProgrammeCourses(String _firstName, String lastName, String email, String programme, String courses) {
        List<String> courseList = new ArrayList<>();
        courseList.add(courses);
        firstName = firstName + "update"; //code14657update
        studentSteps.updateStudent(studentId, firstName, lastName, email, programme, courseList);
